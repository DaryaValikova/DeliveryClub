...
public class DeliveryClubMainPageObject extends AbstractPage {
    ...
    private List<EditableTextField> vendorsList = new ArrayList<EditableTextField>();
...
//        this.driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
    ...
    public void clickEnterBtn() {
        ...
        EditableTextField enterBtn = new EditableTextField(
                waiter.until(
                        ExpectedConditions
                                .presenceOfElementLocated(
                                        By.className("user-login__btn--submit btn-green--sm")))
        );
        enterBtn.click();
    }

    public void fillEmailField() {
        String testUsers = UsersPool.instance.poolUsers();

        EditableTextField loginField =
                new EditableTextField(driver.findElement(By.className("user-login__input")));
        loginField.appendText(testUsers);
    }
    ...
    public void searchPizzaByAddr(String address) {
    ...
    public void findVendors(String name) {
        WebElement vendorCheck =
                driver.findElement(By.linkText(name));
    }

    public void findInvalidMessage() {
        EditableTextField invlidAddressMessage =
                new EditableTextField(
                        waiter.until(
                                ExpectedConditions
                                        .presenceOfElementLocated(
                                                By.xpath("//span[@class='tooltip-v2 tooltip-v2- tooltip-v2-addr-input tooltip-v2__error' and @style='display: inline;']")))
                );
    }

    public void notFindInvalidMessage() {
        EditableTextField invlidAddressMessage =
                new EditableTextField(
                        waiter.until(
                                ExpectedConditions
                                        .presenceOfElementLocated(
                                                By.xpath("//span[@class='tooltip-v2 tooltip-v2- tooltip-v2-addr-input tooltip-v2__error' and @style='display: none;']")))
                );
    }
